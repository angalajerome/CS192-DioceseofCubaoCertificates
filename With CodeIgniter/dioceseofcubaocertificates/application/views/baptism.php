...
<div class="container"> 
	...
	<div class="row">
 	...
 	<!-- Input Section -->
 	<form accept-charset="UTF-8" role="form" action ="<?php echo base_url('index.php/BaptAdd_controller'); ?>" method = "POST">
		<div class="row">
			<label>Register a Person's Baptismal Data</label>
			<br>
			<br>
			<!-- First Name Section -->
		...
		<div class="row">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="birthplace" name="bPlace">
			</div>
			<br>
		...
		<div class="row">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="baptismpriestfullname" name="baptPriestName">
			</div>
			<br>
			<!-- Baptism Sponsor 1 Name Section -->
			<div class="form-group">
				<label for="sponsor1name">Sponsor 1 Name:</label>
				<input type="text" class="form-control" id="sponsor1name" name="baptSponsorA">
			</div>
			<br>
			<!-- Baptism Sponsor 2 Name Section -->
			<div class="form-group">
				<label for="sponsor2name">Sponsor 2 Name:</label>
				<input type="text" class="form-control" id="sponsor2name" name="baptSponsorB">
			</div>
			<br>
		</div>
		<div class="row">
			<div class="col-sm-4">
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" id="baptismbooknumber" min="1" max="100" name="baptBookNum">
				</div>
			</div>
			<div class="col-sm-4">
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" id="baptismpagenumber" min="1" max="100" name="baptPageNum">
				</div>
			</div>
			<div class="col-sm-4">
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" id="baptismlinenumber" min="1" max="100" name="baptLineNum">
				</div>
			</div>
		</div>
		<br>
		<!-- Submit and Add New Baptism Entry Section -->
		<div class="row">
			<br>
			<button type="submit" class="btn btn-primary btn-block"><span class="glyphicon glyphicon-plus"></span> Submit and Add New Baptism Entry</button>
			<br>
		</div>
		<br>
		<br>
