...
<article>
  ...
  <form action ="<?php echo base_url('index.php/BaptAdd_controller'); ?>" method = "POST">
  <br>First Name:
  <input type="text" name="fName"><br> <?php echo("   "); ?>
  Middle Name:
  <input type="text" name="mName"><br><?php echo("   "); ?>
  Last Name:
  ...
  <br>Mother Full Name:
  <input type="text" name="MotherName"><?php echo("   "); ?>
  Father Full Name:
  ...
  <?php echo("   Day  ");?>
    <select name="birthDay"><?php  for ($i=1; $i<=31; $i++){
    ?><option value="<?php echo $i;?>"><?php echo$i;?></option>
    <?php } ?> </select>
  <?php echo("  Year  ");?>
    <select name="birthYear"><?php  for ($i=1900; $i<=2020; $i++){
    ?><option value="<?php echo $i;?>"><?php echo$i;?></option>
    <?php } ?> </select>
  <br>


  <br><b>BAPTISM DETAILS</b><br>

  <br><?php echo("Baptism Parish:");?>
  ...
  <br>
  <?php echo("  Day  ");?>
    <select name="baptDay"><?php  for ($i=1; $i<=31; $i++){
    ?><option value="<?php echo $i;?>"><?php echo$i;?></option>
    <?php } ?> </select>
  <?php echo("  Year  ");?>
    <select name="baptYear"><?php  for ($i=1900; $i<=2020; $i++){
    ?><option value="<?php echo $i;?>"><?php echo$i;?></option>
    <?php } ?> </select>
  <br>
  <br>Baptism Priest Full Name:
  <input type="text" name="baptPriestName"><br>
  <br>Sponsor 1 Name:
  <input type="text" name="baptSponsorA"> <?php echo("   "); ?>
  Sponsor 2 Name:
  <input type="text" name="baptSponsorB"><br>
  <br>Book Number:
  <input type="number" name="baptBookNum" min="1" max="100"><?php echo("   "); ?>
  Page Number:
  <input type="number" name="baptPageNum" min="1" max="100"><?php echo("   "); ?>
  Line Number:
  <input type="number" name="baptLineNum" min="1" max="100"><br>
